...
#endif
{
    ...
    public static class DbEngineDetector {
        ...
        public static void PatchAppConfigConnectionStrings() {
            ...
            Type internalConfigSystemType = configSystemField.GetValue(null).GetType();
            ...
            var internalConfigSystem = (System.Configuration.Internal.IInternalConfigSystem)Activator.CreateInstance(internalConfigSystemType, true);
